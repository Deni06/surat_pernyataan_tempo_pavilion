...
<style type="text/css">
  ...
  <div class="container">
    <a class="navbar-brand brand-logo" href="#">
          <img src="<?=base_url()?>assets/img/cas-logo.png" style="width: auto !important;max-width: 100%;height: 50px;" alt="logo">
        </a>
        <div>          
        </div>    
  </div>
...
<div class="container" style="text-align: center;">
  <h3 class="mt-4" style="font-weight: bold;">Invalid Serial Number</h3>
  <hr style="border-color: black">
  <p style="color: #717171;line-height: 2" id="body">Please Contact CAS Admin to solve this problem</p>    
</div>
      </div>
